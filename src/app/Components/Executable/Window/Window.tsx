  ...
  return (
    ...
    >
      ...
      >
        ...
        {/* CONTENT */}
        <div className="flex min-h-full w-full bg-neutral-100 text-neutral-900 relative z-100">
          <div className=" min-h-full h-full w-full overflow-scroll ">
            {/* TITLE */}
            <div className="flex max-w-full h-[40%] gap-4 p-4">
              <h1 className="basis-1/2 flex items-center justify-end text-right text-4xl border border-black ">{`${client?.title}`}</h1>
              <div className="basis-1/2 flex items-center justify-start relative border border-black">
