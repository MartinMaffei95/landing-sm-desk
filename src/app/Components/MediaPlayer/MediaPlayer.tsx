...
const MediaPlayer = () => {
  ...
  return (
    <div className="bg-neutral-900 flex flex-col w-full h-full text-neutral-50 font-w98">
      <div className="basis-10/12 flex p-none justify-center">
        {hasWindow && (
          <ReactPlayer
            height="100%"
      ...
      <div className="bg-neutral-300 p-4 gap-4 flex flex-col basis-1/12">
        <div className="h-4 w-full bg-neutral-200 inlined "> </div>
        <ControlsSection actions={player} />
      </div>
      <div className="px-8 basis-1/12 text-lime-600 ">
        Somos_SocialMedia1989.avi
      </div>
    </div>
  )
}
